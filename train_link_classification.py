...
from models.KTGMF import KTGMF
...
if __name__ == "__main__":
    ...
    for run in range(args.num_runs):
        ...
        elif args.model_name == 'KTGMF':
            dynamic_backbone = KTGMF(node_raw_features=node_raw_features,
                                        edge_raw_features=edge_raw_features,
                                        dropout=args.dropout,
                                        num_neighbors=args.num_neighbors,
                                        device=args.device,
        ...
        if args.model_name in ['DyGKT','KTGMF']:
        ...
        for epoch in range(args.num_epochs):
            if args.test and epoch > 0:
                ...
                sys.exit()
            model.train()
            if args.model_name in ['DyGKT','QIKT','IEKT','IPKT','DIMKT', 'TGAT', 'TGN', 'DyGFormer','DKT','AKT','CTNCM','simpleKT','KTGMF']:
            ...
            for batch_idx, train_data_indices in enumerate(train_idx_data_loader_tqdm):
                ...
                if args.model_name in ['DyGKT','DKT','AKT','CTNCM','simpleKT','KTGMF']:
