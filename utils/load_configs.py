...
def get_link_classification_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--model_name', type=str, default='KTGMF', help='name of the model',
                        choices=['DyGKT','QIKT','IEKT','IPKT','DIMKT','simpleKT','CTNCM','AKT','DKT', 'TGAT', 'TGN', 'DyGFormer','DyGKT'])
